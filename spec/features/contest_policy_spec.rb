...
RSpec.describe 'ContestPolicy', type: :feature, ui: true do
  describe 'registration' do
    ...
    context 'when closed' do
      ...
      it { expect(page).to have_no_css 'form#regform', visible: :all }
      it { expect(page).to have_no_button 'commit' }
    end
  ...
  describe 'upload' do
    ...
    context 'when closed' do
      ...
      it { expect(page).to have_no_css 'form', visible: :all }
      it { expect(page).to have_no_button 'commit' }
    end
